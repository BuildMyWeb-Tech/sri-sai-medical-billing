    ...
    return (
      <div className="flex items-center gap-1">
        <input
          ...
          className="w-16 px-2 py-1 text-sm border border-green-400 rounded-md outline-none ring-2 ring-green-100 bg-white"
        />
        <button
          onClick={save}
          disabled={saving}
        ...
        <td className="px-5 py-4">
          <div className="flex items-center gap-1">
            <button
              ...
              className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-green-700 bg-green-50 hover:bg-green-100 text-xs font-medium transition-colors"
            >
              <Layers size={12} />
              Variants
            ...
            {variants.length === 0 ? (
              ...
              <div className="rounded-lg border border-green-100 bg-white overflow-hidden">
                <table className="w-full text-sm">
                  <thead>
                    <tr className="bg-green-50 border-b border-green-100">
                      <th className="text-left px-4 py-2.5 font-semibold text-green-700 text-xs uppercase">
                        Size
                      </th>
                      <th className="text-left px-4 py-2.5 font-semibold text-green-700 text-xs uppercase">
                        Price
                      ...
                      <th className="text-left px-4 py-2.5 font-semibold text-green-700 text-xs uppercase hidden sm:table-cell">
                        Status
                      </th>
                    </tr>
                  </thead>
                    ...
                    {variants.map((v, idx) => (
                      ...
                      >
                        <td className="px-4 py-2.5">
                          <span className="inline-flex items-center justify-center w-9 h-7 bg-green-600 text-white rounded-md text-xs font-bold">
                            {v.size}
                          </span>
                        </td>
                        <td className="px-4 py-2.5">
                ...
                <div className="px-4 py-2 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <button
                    onClick={() => (window.location.href = `/admin/add-product?id=${product.id}`)}
        ...
        <div className="mb-8 flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-1 text-sm">
              Admin-created products — expand to manage size variants
            </p>
          </div>
          <div className="flex items-center gap-3">
