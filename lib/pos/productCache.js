...
/**
 * Immediately patch _memCache stock values after a bill is completed.
 * Prevents stale stock showing on next scan before server refresh arrives.
 */
export function patchLocalStock(items) {
  for (const { variantId, quantity } of items) {
    ...
    // Also patch barcode index entries
